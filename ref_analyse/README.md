...
This directory is a component-oriented architecture study of the local `hermes-agent/` checkout. Code references use `$HERMES` as an alias for the Hermes repository root, for example `$HERMES/hermes_state.py:583`.
